 ...
 * Created on 8/15/17.
 *
 * @author Czipperz from StackOverflow based on Alexander.Berg answer on same post.
 */
public class ResizeHelper {
	...
	private static class ResizeListener implements EventHandler<MouseEvent> {
		...
		public void handle(MouseEvent mouseEvent) {
			...
			//prevent from dragging if style is transparent
			if(!controller.getChkHideShow().isSelected()){
